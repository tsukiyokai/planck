...
# impl_topo: 8卡HCCS拓扑实现

> 状态: NODE已完成 — topo.rs在Phase A中已完整实现

## 验证清单

| 要求                                        | 代码位置                    | 状态 |
|:-------------------------------------------|:--------------------------|:-----|
| Link {src, dst, bandwidth_gbps, latency_us, transport} | topo.rs:22-29     | done |
| TransportType enum (Hccs/Roce/Shm)         | topo.rs:14-20             | done |
| Topology {num_ranks, links}                 | topo.rs:31-35             | done |
| Topology::hccs_8card() 56条有向链路          | topo.rs:39-56             | done |
| has_link(src, dst)                          | topo.rs:58-60             | done |
| get_link(src, dst)                          | topo.rs:62-64             | done |
| ring_order() -> [0,1,...,7]                 | topo.rs:67-69             | done |
| test: hccs_8card_basics (56 links)          | topo.rs:79-84             | pass |
| test: hccs_8card_ring_neighbors             | topo.rs:87-95             | pass |
| test: link_properties (Hccs, bw>0, lat>0)  | topo.rs:98-104            | pass |
| cargo test 全量                             | 29 passed, 0 failed       | pass |

## 结论

topo.rs在Phase A (Chunk 2, Task 3)中已完整实现。NODE_COMPLETE

---

# impl_cost: Alpha-Beta-Gamma代价模型

> 状态: NODE已完成 — cost.rs在Phase A中已完整实现

## 验证清单

| 要求                                  | 代码位置          | 状态 |
|:-------------------------------------|:-----------------|:-----|
| CostModel {alpha, beta, gamma}       | cost.rs:8-12     | done |
| from_topology(): 提取alpha/beta      | cost.rs:16-24    | done |
| ring_allreduce(msg_size, num_ranks)  | cost.rs:28-34    | done |
| test: cost_from_topology             | cost.rs:44-50    | pass |
| test: ring_allreduce_cost_scales     | cost.rs:53-61    | pass |
| test: ring_cost_formula 精确校验      | cost.rs:64-73    | pass |
| cargo test 全量                      | 29 passed        | pass |

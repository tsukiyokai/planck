...
impl PlanTemplate {
    ...
    pub fn instantiate(&self, msg_size: usize) -> ExecutionPlan {
        ...
        ExecutionPlan { header, buffers, ops: self.frozen_ops.clone() }
    }
}
...
mod tests {
    use super::*;
    use crate::{
        plan::{compile, Collective, CompileRequest, ReduceOp},
        topo::Topology,
    };
